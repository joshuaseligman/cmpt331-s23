...
<model definition> $\rightarrow$ model <model name> <parent declaration> 
                                 <block begin> <statements> <block end> <model name> \\
...
start
    ...
    pub fn quicksort(&self, &mut Vec<i32> data) -> void
    start
    ...
    start
        ...
        self.quicksort_with_indices(data, start, partition_out - 1);
        self.quicksort_with_indices(data, partition_out + 1, end);
    ...
    // Knuth shuffle
    pub fn knuth_shuffle(&self, &mut Vec<i32> data) -> void
    start
...
start
    ...
    pub fn selection_sort(&self, &mut Vec<i32> data>) -> void
...
start
    ...
    pub fn Transformer(String my_name, String my_car_name, i32 power)
    start
        self.name := my_name;
    ...
    // < 0 means loss
    // == 0 means draw
    pub fn attack(&self, &Transformer oponent) -> i32
    start
    ...
    pub fn supercharge(&mut self, i32 factor)
    start
    ...
    pub fn get_leader(&self) -> &Transformer
    start
        return self.leader;
    finish get_leader

    // Define a setter for the leader
    pub fn set_leader(&mut self, &Transformer new_leader)
    start
        self.leader := new_leader;
    finish set_leader

    // Define a setter for the owner
    pub fn set_owner(&mut self, &Owner new_owner)
    start
...
start
    pub fn Autobot(String my_name, String my_car_name, i32 power)
    start
