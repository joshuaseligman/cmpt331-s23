...
longer reads from left to right. Rather, one has to read it middle out (sadly not related to middle out compression in the TV show Silicon Valley) and build a mini
syntax tree in their head to be able to actually understand what the code is doing.
\\ \\
...
\lstinputlisting[caption = LISP Output]{./../lisp/caesar.log}
